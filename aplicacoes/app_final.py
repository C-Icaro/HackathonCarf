...
# -*- coding: utf-8 -*-
"""
Aplicação Web CARF ML Predictor - Versão Simplificada
"""
    ...
    if st.button("🔮 Prever Probabilidades", type="primary"):
        if texto_ementa.strip():
            ...
            if erro:
                ...
                st.markdown("### Probabilidades por Tipo de Votação")
                ...
                st.success(f"🎯 **Predição Principal:** {predicao_principal} ({confianca:.1%})")
