...
# -*- coding: utf-8 -*-
"""
Script de Demonstração do Modelo CARF Expandido
...
def main():
    ...
    print("=" * 70)
    print("CARF ML PREDICTOR EXPANDIDO - DEMONSTRACAO")
    print("=" * 70)
    ...
    print("Para usar a interface web, execute: streamlit run app_expandido.py")
    print(f"{'=' * 70}")
